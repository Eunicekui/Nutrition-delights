...
<style>
    ...
    .therapist-booking .container h2 {
        padding-bottom: 20px;
    }

    .therapist-booking .container form {
        display: flex;
        flex-direction: column;
        width: 100%;
        height: 100%;
    ...
    .therapist-booking .container form label {
        padding-bottom: 10px;
        font-size: 17px;
        font-weight: 800;
        color: black;
    ...
    .therapist-booking .container form input {
        width: 90%;
        height: 5vh;
    }

    .therapist-booking .container form select {
        width: 90%;
        height: 5vh;
    }

    .therapist-booking .container form button {
        width: 10vw;
    }
</style>
...
<body>
    ...
    <section class="therapist-booking">
            ...
            <form action="Nutrition-admin-panel/admin/code.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="therapist_id" class="form-select" required>
                        ...
                        $query = "SELECT id, name FROM therapists";
                        ...
                        if ($result) {
                            ...
                            while ($therapist = mysqli_fetch_assoc($result)) {
                                echo "<option value='" . $therapist['id'] . "'>" . htmlspecialchars($therapist['name']) . "</option>";
                            }
                        } else {
                            // Handle query failure
                            echo "<option value=''>Error loading therapists</option>";
                        }
                        ?>
                    </select>
                    </select>
                ...
                <button type="submit" name="bookTherapist" class="btn btn-primary">Book Appointment</button>
            </form>
        </div>
    </section>
