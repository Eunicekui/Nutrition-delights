            ...
            <div class="card-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $bookings = getAll('booking_therapist');
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?= $bookingItem['therapist_id']; ?></td>
                                    ...
                                    <td>
                                        <a href="therapist-approve.php?id=<?= $bookingItem['id']; ?>" class="btn btn-success btn-sm">Approve</a>
                                        <a href="booking-therapist-delete.php?id=<?= $bookingItem['id']; ?>"
