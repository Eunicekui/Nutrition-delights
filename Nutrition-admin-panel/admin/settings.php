            ...
            <div class="card-body">
                ...
                <form action="code.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <br>
                        <textarea name="meta_description" class="from-control" cols="127" rows="3"><?= $setting['data']['meta_description'] ?? "" ?> </textarea>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label>Meta Keyword</label>
                        <br>
                        <textarea name="meta_keyword" class="from-control" cols="127" rows="3"><?= $setting['data']['meta_keyword'] ?? "" ?> </textarea>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label>Address</label>
                            <br>
                            <textarea name="address" class="from-control" cols="127" rows="3"><?= $setting['data']['address'] ?? "" ?> </textarea>
                        </div>
                    </div>
