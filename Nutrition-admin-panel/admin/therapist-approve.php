    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4>Approve Therapist Bookings</h4>
                <a href="booking_therapist.php" class="btn btn-danger btn-sm mb-0 float-end">Back</a>
            </div>
            <div class="card-body">
                ...
                $booking_doctor = getById('booking_therapist', checkParamId('id'));
                ...
                ?>
                    ...
                    <table class="table table-bordered table-stripped">
                        <tbody>
                            ...
                            <tr>
                                <td>Therapist</td>
                                <td><?= $booking_doctor['data']['therapist_id']; ?></td>
                            </tr>
                            <tr>
                                <td>Date</td>
                        ...
                        <div class="card border card-body">
                            ...
                            <form action="code.php" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <br>
                                        <button type="submit" name="updateTherapistBook" class="btn btn-primary">Update Status</button>
                                    </div>
                                </div>
                            </form>
                        </div>
